...
#
# note: s.source currently points to a repository different from 
#       https://github.com/pebble/pebblekit.git
#       as the beta releases haven't been published, there
#
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/pebble/pebblekit.git", :branch => "master" }
  s.platform     = :ios, '5.0'
